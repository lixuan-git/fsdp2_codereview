...
//
///*****************************************
// * <p>Title: Excel转Html工具类</p>
// * <p>Description: </p>
// * <p>Company: 合肥非度信息技术有限公司</p> 
// * @author	Charlee
// * @date	2018年6月14日下午2:51:52
// * @version 1.0
// *****************************************/
...
//	 * @param isWithStyle	是否需要样式(通常为true)
//	 * @return
//	 * @author Charlee
//	 * @date 2018年6月14日
//	 */
//	public static boolean excelToHtml(String sourcePath, String targetPath , boolean isWithStyle) {
//		// 判断文件是否存在
...
//		String excleName = tempFile.getName();
//		String fileName = excleName.substring(0, excleName.indexOf("."));	//文件名
//		
//		InputStream is = null;
...
//				FileUtils.writeFile(htmlExcel, targetPath + File.separator + fileName + ".html");
...
//					if (NonUtil.isNon(cell)) { // 特殊情况 空白的单元格会返回null
//						sb.append("<td>&nbsp;</td>");
//						continue;
//					}
//
...
//
//					sb.append(">");
//					if (NonUtil.isNon(stringValue.trim())) {
//						sb.append(" &nbsp; ");
//					} else {
...
//						result = DateUtil.format(date, "HH:mm");
//					} else {// 日期
...
//					result = DateUtil.format(date, "MM-dd");
//				} else {
//					double value = cell.getNumericCellValue();
...
//				if (NonUtil.isNotNon(xc) && !"".equals(xc)) {
//					sb.append("color:#" + xc.getARGBHex().substring(2) + ";"); // 字体颜色
//				}
//
//				XSSFColor bgColor = (XSSFColor) cellStyle.getFillForegroundColorColor();
//				if (NonUtil.isNotNon(bgColor) && !"".equals(bgColor)) {
...
//				if (NonUtil.isNotNon(fontColorStr) && !"".equals(fontColorStr.trim())) {
...
//				if (NonUtil.isNotNon(bgColorStr) && !"".equals(bgColorStr.trim())) {
...
//		if (NonUtil.isNotNon(str) && str.length() < 2) {
//			return "0" + str;
//		}
//		return str;
//	}
