...
/**
 * <p>description: 唯一数字字符串生成工具</p>
 * <p>author: chensh</p>
 * <p>date: 2017年7月12日上午9:20:25</p>
 */
public final class KeyUtil {
    /**
     * 获取全局(包括分布式环境)不重复的十六进制数字字符串(24位)<p>
     */
    ...
    public static String getId() {
        return new BigInteger(getKey(), 16).toString(30);
    }
     ...
     * @return 该id的生成时间
     */
    public static Date getCreateTime(String key) {
        if (key.length() == 24) {
            return new ObjectId(key).getDate();
        } else if (key.length() == 20) {
            return new ObjectId(new BigInteger(key, 30).toString(16)).getDate();
        }
        return null;
    }
...
/**
 * <p>description: 采用mongoDB的ObjectID获取全局唯一的24位字符串</p>
 * <p>author: chensh</p>
 * <p>date: 2017年7月12日上午9:13:16</p>
 */
            ...
            while (e.hasMoreElements()) {
                ...
                if (mac != null) {
                    ...
                    try {
                        ...
                        LOGGER.error("{}生成字符串失败！",shortHardwareAddressException);
                        throw new RuntimeException(shortHardwareAddressException);
                    }
                }
            }
