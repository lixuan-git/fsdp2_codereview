...
<script language="javascript">
	...
	var echartOption= {
		...
		timeTicket = setInterval(function (){
			...
			echartOption.series[1].data[0].value = (Math.random()*7).toFixed(2) - 0;
			echartOption.series[2].data[0].value = (Math.random()*2).toFixed(2) - 0;
			echartOption.series[3].data[0].value = (Math.random()*2).toFixed(2) - 0;
