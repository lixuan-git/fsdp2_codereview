...
<div region="center" style="padding:5px;" border="false">
  <div class="easyui-panel" title="当前位置：权限资源管理  &gt; 权限视图管理 &gt; 修改视图节点" style="width:auto;padding:10px;" fit="true">
	<form method="post" action="${ctx }/finedo/rightsview/modify?nodeid=${node.nodeid}" id="ajaxForm" >		
